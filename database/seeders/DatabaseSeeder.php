...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $specialties = [
            ...
            ['name' => 'انف اذن وحنجره', 'description' => 'تخصص يدرس الامراض والالتهابات التي تخص الانف.'],
            ['name' => 'الكلى والمجاري البولية', 'description' => 'تخصص يركز على الرعاية الصحية الشاملة لأفراد الأسرة.'],
            ...
            ['name' => 'السونار', 'description' => 'تخصص يركز على استخدام الفحوصات والاختبارات الطبية لتشخيص الأمراض والحالات الصحية.'],
            ...
            ['name' => 'مفاصل وكسور', 'description' => 'تخصص يعنى بتقديم التغذية المناسبة والمخصصة لمرضى الأمراض المزمنة والحالات الصحية الخاصة.'],
